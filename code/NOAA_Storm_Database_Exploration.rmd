...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ggplot(data=top10health, aes(x=reorder(EVTYPE, -sumhazards), y=sumhazards)) +
        geom_bar(stat="identity") +
        theme(axis.text.x=element_text(angle=45, hjust=1))

ggplot(data=top10health, aes(x=reorder(EVTYPE, -sumfatalities), y=sumfatalities)) +
        geom_bar(stat="identity") +
        theme(axis.text.x=element_text(angle=45, hjust=1))

ggplot(data=top10health, aes(x=reorder(EVTYPE, -suminjuries), y=suminjuries)) +
        geom_bar(stat="identity") +
        theme(axis.text.x=element_text(angle=45, hjust=1))
```
...
# Plot the top 10 event types in descending order of magnitude
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ggplot(data=top10econ, aes(x=reorder(EVTYPE, -sumtotaldmg), y=sumtotaldmg)) +
        geom_bar(stat="identity") +
        theme(axis.text.x=element_text(angle=45, hjust=1))

ggplot(data=top10econ, aes(x=reorder(EVTYPE, -sumpropdmg), y=sumpropdmg)) +
        geom_bar(stat="identity") +
        theme(axis.text.x=element_text(angle=45, hjust=1))

ggplot(data=top10econ, aes(x=reorder(EVTYPE, -sumcropdmg), y=sumcropdmg)) +
        geom_bar(stat="identity") +
        theme(axis.text.x=element_text(angle=45, hjust=1))
```
